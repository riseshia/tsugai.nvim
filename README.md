...
The design lives in [spec.md](spec.md). This is an early proof of concept: in-file templates, chat, edit proposals, command proposals and plans for changes across files work.
